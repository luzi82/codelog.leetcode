...
class Test {
    ...
    public static void test(String matrixStr,boolean expected){
        System.out.println(String.format("matrix=%s, expected=%s",matrixStr,expected));
        int[][] matrix = toIntAryQAryQ(toIntQAryQAryQ(matrixStr.toCharArray(),0).second);
