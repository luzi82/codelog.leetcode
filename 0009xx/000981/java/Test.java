...
class Test {
    ...
    public static void main(String[] argv){
      ...
      kv = new TimeMap();
      kv.set("foo", "bar", 1);
      aassert(kv.get("foo", 1).equals("bar"));
      aassert(kv.get("foo", 3).equals("bar"));
      kv.set("foo", "bar2", 4);
      aassert(kv.get("foo", 4).equals("bar2"));
      aassert(kv.get("foo", 5).equals("bar2"));

      kv = new TimeMap();
      kv.set("love","high",10);
      kv.set("love","low",20);
      aassert(kv.get("love",5).equals(""));
      aassert(kv.get("love",10).equals("high"));
      aassert(kv.get("love",15).equals("high"));
      aassert(kv.get("love",20).equals("low"));
      aassert(kv.get("love",25).equals("low"));
    }
