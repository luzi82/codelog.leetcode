...
class Test {
    ...
    public static void test(String firstListStr,String secondListStr,String expectedStr){
        System.out.println(String.format("firstList=%s, secondList=%s, expected=%s",firstListStr,secondListStr,expectedStr));
        int[][] firstList = toIntAryQAryQ(firstListStr);
        int[][] secondList = toIntAryQAryQ(secondListStr);
        Solution solution = new Solution();
        int[][] result = solution.intervalIntersection(firstList,secondList);
        System.out.println(String.format("result=%s",join(result)));
        aassert(join(result).equals(expectedStr));
    }
