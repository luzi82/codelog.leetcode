...
fun main() {
  test(
    arrayOf<String>("KiTe","kite","hare","Hare"),
    arrayOf<String>("kite","Kite","KiTe","Hare","HARE","Hear","hear","keti","keet","keto"),
    arrayOf<String>("kite","KiTe","KiTe","Hare","hare","","","KiTe","","KiTe")
  )
  test(
    arrayOf<String>("yellow"),
    arrayOf<String>("YellOw"),
    arrayOf<String>("yellow")
  )
}

fun test(wordlist: Array<String>, queries: Array<String>, expected: Array<String>) {
  println("wordlist=%s, queries=%s, expected=%s".format(join(wordlist), join(queries), join(expected)))
  var solution: Solution = Solution()
  var result: Array<String> = solution.spellchecker(wordlist, queries)
...
fun join(ary: Array<String>): String {
  var sb: StringBuffer = StringBuffer()
  sb.append("[")
  var isFirst: Boolean=true
  for(v in ary){
