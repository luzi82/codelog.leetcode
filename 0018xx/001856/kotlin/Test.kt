...
fun test(numss: String, expected: Int) {
  println("nums=%s, expected=%d".format(numss, expected))
  val nums = toIntArray(toIntQAryQ(numss.toCharArray(),0).second!!)
  var solution: Solution = Solution()
  var result: Int = solution.maxSumMinProduct(nums)
