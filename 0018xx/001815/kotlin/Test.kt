...
fun test(numss1:String, numss2:String, expected: Int) {
  println("nums1=%s, nums2=%s, expected=%d".format(numss1, numss2, expected))
  val nums1 = toIntArray(toIntQAryQ(numss1.toCharArray(),0).second!!)
  val nums2 = toIntArray(toIntQAryQ(numss2.toCharArray(),0).second!!)
  var solution: Solution = Solution()
  var result: Int = solution.maxDistance(nums1,nums2)
