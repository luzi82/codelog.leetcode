...
fun main() {
  val treeNode = toTreeNode("[7,3,15,null,null,9,20]")
  val bstItr = BSTIterator(treeNode)
  aassert(bstItr.next()==3)
  aassert(bstItr.next()==7)
  aassert(bstItr.hasNext()==true)
  aassert(bstItr.next()==9)
  aassert(bstItr.hasNext()==true)
  aassert(bstItr.next()==15)
  aassert(bstItr.hasNext()==true)
  aassert(bstItr.next()==20)
  aassert(bstItr.hasNext()==false)
}
