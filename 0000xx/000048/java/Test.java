...
class Test {
    ...
    public static void test(String matrixStr,String expectedStr){
        System.out.println(String.format("matrix=%s, expected=%s",matrixStr,expectedStr));
        int[][] matrix = toIntAryQAryQ(matrixStr);
        Solution solution = new Solution();
        solution.rotate(matrix);
        System.out.println(String.format("result=%s",join(matrix)));
        aassert(join(matrix).equals(expectedStr));
    }
