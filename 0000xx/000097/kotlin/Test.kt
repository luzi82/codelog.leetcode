...
fun test(s1: String, s2: String, s3: String, expected: Boolean) {
  println("s1=%s, s2=%s, s3=%s, expected=%s".format(s1,s2,s3, expected))
  var solution: Solution = Solution()
  var result: Boolean = solution.isInterleave(s1,s2,s3)
