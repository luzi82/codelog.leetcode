...
class Test {
    ...
    public static void test(String heightStr,int expected){
        System.out.println(String.format("height=%s, expected=%d",heightStr,expected));
        int[] height = toIntAryQ(heightStr);
