...
class Test {
    ...
    public static void main(String[] argv){
        ...
        test("AAABBB",2,8);
        test("AAABBB",0,6);
        test("AAAAAABCDEFG",2,16);
    }
    
    public static void test(String tasksStr,int n,int expected){
        System.out.println(String.format("tasks=%s, n=%d, expected=%d",tasksStr,n,expected));
        Solution solution = new Solution();
        int result = solution.leastInterval(tasksStr.toCharArray(),n);
