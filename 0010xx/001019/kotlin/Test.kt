...
fun test(headd: String, expected: String) {
  println("head=%s, expected=%s".format(headd, expected))
  val head = toListNode(headd)
  var solution: Solution = Solution()
  var result: IntArray = solution.nextLargerNodes(head)
  println("result=%s".format(join(result)))
  aassert(join(result) == expected)
}
