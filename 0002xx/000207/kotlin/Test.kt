...
fun test(numCourses: Int, prerequisites: Array<IntArray>, expected: Boolean) {
  println("numCourses=%d, prerequisites=%s, expected=%s".format(numCourses, join(prerequisites), expected))
  var solution: Solution = Solution()
  var result: Boolean = solution.canFinish(numCourses,prerequisites)
