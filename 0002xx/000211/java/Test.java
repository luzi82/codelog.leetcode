...
class Test {
    ...
    public static void main(String[] argv){
        ...
        aassert(wordDictionary.search("pad")==false); // return False
        aassert(wordDictionary.search("bad")==true); // return True
        aassert(wordDictionary.search(".ad")==true); // return True
        aassert(wordDictionary.search("b..")==true); // return True
    }
