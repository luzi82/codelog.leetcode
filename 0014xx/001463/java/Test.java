...
class Test {
    ...
    public static void main(String[] argv){
        ...
        test("[[1,0,0,3],[0,0,0,3],[0,0,3,3],[9,0,3,3]]",22);
        test("[[1,1],[1,1]]",4);
    }
    
    public static void test(String gridStr,int expected){
        System.out.println(String.format("grid=%s, expected=%d",gridStr,expected));
        int[][] grid = toIntAryQAryQ(gridStr);
