...
class Test {
    ...
    public static void main(String[] argv){
        // given
        test("[1,4,8,10,20]",3,5);
        test("[2,3,5,12,18]",2,9);
        test("[7,4,6,1]",1,8);
        test("[3,6,14,10]",4,0);
    }
    
    public static void test(String housesStr,int k,int expected){
        System.out.println(String.format("houses=%s, k=%d, expected=%d",housesStr,k,expected));
        int[] houses = toIntAryQ(housesStr);
