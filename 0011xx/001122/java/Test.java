...
class Test {
    ...
    public static void test(String arr1Str,String arr2Str,String expectedStr){
        System.out.println(String.format("arr1=%s, arr2=%s, expected=%s",arr1Str,arr2Str,expectedStr));
        int[] arr1 = toIntAryQ(arr1Str);
        int[] arr2 = toIntAryQ(arr2Str);
