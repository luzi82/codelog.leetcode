...
fun main() {
  test(intArrayOf(1,2,3,4),intArrayOf(-1,4,5,6),13)
  test(intArrayOf(1,-2,-5,0,10),intArrayOf(0,-2,-1,-7,-4),20)
}

fun test(arr1:IntArray, arr2:IntArray, expected: Int) {
  println("arr1=%s, arr2=%s, expected=%d".format(join(arr1), join(arr2), expected))
  var solution: Solution = Solution()
  var result: Int = solution.maxAbsValExpr(arr1,arr2)
