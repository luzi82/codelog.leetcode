...
class Test {
    ...
    public static void main(String[] argv){
        // given
        test(new String[]{"cat","bt","hat","tree"},"atach",6);
        test(new String[]{"hello","world","leetcode"},"welldonehoneyr",10);
    }
    
    public static void test(String[] words,String chars,int expected){
        System.out.println(String.format("words=%s, chars=%s, expected=%d",join(words),chars,expected));
