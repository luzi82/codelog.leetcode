...
class Test {
    ...
    public static void test(String s, String p, String expectedStr){
        System.out.println(String.format("s=%s, p=%s, expected=%s",s,p,expectedStr));
        Solution solution = new Solution();
        List<Integer> resultList = solution.findAnagrams(s,p);
        Integer[] resultAry = resultList.toArray(new Integer[0]);
        System.out.println(String.format("result=%s",join(resultAry)));
        aassert(join(resultAry).equals(expectedStr));
    }
