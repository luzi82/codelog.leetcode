...
fun test(boardd: Array<String>, expected: Int) {
  println("board=%s, expected=%d".format(join(boardd), expected))
  val board=Array(boardd.size){i->boardd[i].toCharArray()}
  var solution: Solution = Solution()
  var result: Int = solution.countBattleships(board)
