...
class Test {
    ...
    public static void test(int[] nums,int[] multipliers,int expected){
        System.out.println(String.format("nums=%s, multipliers=%s, expected=%d",join(nums),join(multipliers),expected));
