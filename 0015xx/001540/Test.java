...
class Test {
    ...
    public static void test(String s, String t, int k,boolean expected){
        System.out.println(String.format("s=%s, t=%s, k=%d, expected=%s",s,t,k,expected));
        Solution solution = new Solution();
        boolean result = solution.canConvertString(s,t,k);
