...
class Test {
    ...
    public static void main(String[] argv){
        // given
        test("Bob hit a ball, the hit BALL flew far after it was hit.",new String[]{"hit"},"ball");
        test("a.",new String[]{},"a");
    }
    
    public static void test(String paragraph, String[] banned, String expected){
        System.out.println(String.format("paragraph=%s, banned=%s expected=%s",paragraph,join(banned),expected));
